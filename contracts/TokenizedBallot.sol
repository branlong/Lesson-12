...
contract Ballot {
    ...
    function changeTargetBlock(uint256 newTargetBlock) external {
        require(contractCreator == msg.sender, "Only the creator of the ballot may change the target block for the snapshot.");
